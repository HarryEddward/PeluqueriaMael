...
class TestSaveTokensToJson(unittest.TestCase):
    ...
    def test_path_services(self) -> None:
        ...
        response = requests.post(self.url + "/services", json=send, verify=False)
    ...
    #@unittest.skip("#")
    def test_path_appointments(self) -> None:
        ...
        response = requests.post(self.url + "/appointments", json=send, verify=False)
