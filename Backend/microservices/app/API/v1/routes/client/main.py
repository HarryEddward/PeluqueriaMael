...
from Backend.microservices.app.API.v1.routes.client.restricted.main import router as router_restricted
from Backend.microservices.app.API.v1.routes.client.public.main import router as router_public
